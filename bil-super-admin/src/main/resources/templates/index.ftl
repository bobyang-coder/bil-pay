...
<body style="background-image: url('images/body/sunny.jpg')">
<div>
    <!--BEGIN 主题设置-->
    ...
    <div id="header-topbar-option-demo" class="page-header-topbar">
        <nav id="topbar" role="navigation" style="margin-bottom: 0;" data-step="3"
            ...
            <div class="navbar-header">
                ...
                <a id="logo" href="index.ftl" class="navbar-brand"><span class="fa fa-rocket"></span><span
                        class="logo-text">Bil-Super-Boss</span><span style="display: none"
            ...
            <div class="topbar-main"><a id="menu-toggle" href="#" class="hidden-xs"><i class="fa fa-bars"></i></a>
                ...
                <form id="topbar-search" action="" method="" class="hidden-sm hidden-xs">
                    <div class="input-icon right text-white"><a href="#"><i class="fa fa-search"></i></a><input
                            type="text" placeholder="搜索" class="form-control text-white"/></div>
                </form>
                ...
                <ul class="nav navbar navbar-top-links navbar-right mbn">
                    ...
                    <li class="dropdown topbar-user"><a data-hover="dropdown" href="#" class="dropdown-toggle"><img
                            ...
                            class="hidden-xs">bob</span>&nbsp;<span class="caret"></span></a>
                        <ul class="dropdown-menu dropdown-user pull-right">
                            <li><a href="#"><i class="fa fa-user"></i>个人资料</a></li>
                            <li><a href="#"><i class="fa fa-calendar"></i>日历</a></li>
                            <li>
                                <a href="#"><i class="fa fa-envelope"></i>收件箱
                    ...
                    <li id="topbar-chat" class="hidden-xs">
                        <a href="javascript:void(0)" data-step="4"
                           ...
                           data-position="left" class="btn-chat">
    ...
    <div id="wrapper">
                ...
                <ul id="side-menu" class="nav">
                    ...
                    <li>
                        <a href="Layout.html">
                            ...
                            <span class="menu-title">布局</span>
                        </a>

                    </li>
                    <li><a href="UIElements.html"><i class="fa fa-send-o fa-fw">
                        <div class="icon-bg bg-green"></div>
                    </i><span class="menu-title">UI元素</span></a>
        ...
        <div id="page-wrapper">
            ...
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    <li>
                        ...
                        <a href="dashboard.html"><i class="fa fa-home"></i>&nbsp;首页</a>&nbsp;&nbsp;<i
                            class="fa fa-angle-right"></i>&nbsp;&nbsp;
                    </li>
                    <li class="hidden">
                        <a href="#">仪表盘</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;
                    </li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <span class="task-item">CPU Usage (25 - 32 cpus)<small
                                                    class="pull-right text-muted">40%</small><div
                                                ...
                                                </span><span>Disk Usage (C:\ 120GB , D:\ 430GB)<small
                                                class="pull-right text-muted">55%</small><div
                                                class="progress progress-sm">
                                                ...
                                                </span><span>Domain (2/5)<small
                                                class="pull-right text-muted">66%</small><div
                                                class="progress progress-sm">
                                                ...
                                                </span><span>Database (90/100)<small
                                                class="pull-right text-muted">90%</small><div
                                                class="progress progress-sm">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="chat-form">
                                        <div class="input-group">
                                            <input id="input-chat" type="text" placeholder="Type a message here..."
                                    ...
                                    <div class="profile">
                                        <div style="margin-bottom: 15px" class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-4 text-center">
                                                <figure><img src="images/avatar/128.jpg" alt=""
                                                             style="display: inline-block"
                                                             class="img-responsive img-circle"/>
                                                    <figcaption class="ratings"><p><a href="#"><span
                                ...
                                <article class="timeline-entry">
                                    <div class="timeline-entry-inner">
                                        <time datetime="2014-01-10T03:45" class="timeline-time">
                                            <span>12:45 AM</span><span>Today</span></time>
                                        ...
                                        <div class="timeline-label"><h4 class="timeline-title">New Project</h4>
                                            ...
                                            <p>Tolerably earnestly middleton extremely distrusts she boy now not. Add
                                                and offered prepare how cordial.</p></div>
                                    </div>
                                </article>
                                <article class="timeline-entry left-aligned">
                                    <div class="timeline-entry-inner">
                                        <time datetime="2014-01-10T03:45" class="timeline-time">
                                            <span>9:15 AM</span><span>Today</span></time>
                                        ...
                                        <div class="timeline-label bg-green"><h4 class="timeline-title">Job Meeting</h4>
                                            ...
                                            <p>Caulie dandelion maize lentil collard greens radish arugula sweet pepper
                                                water spinach kombu courgette.</p></div>
                                    </div>
                                </article>
                                <article class="timeline-entry">
                                    <div class="timeline-entry-inner">
                                        <time datetime="2014-01-09T13:22" class="timeline-time">
                                            <span>8:20 PM</span><span>04/03/2013</span></time>
                                        <div class="timeline-icon bg-orange"><i class="fa fa-paper-plane"></i></div>
                                        <div class="timeline-label bg-orange"><h4 class="timeline-title">Daily
                                            Feeds</h4>

                                            <p><img src="http://lorempixel.com/45/45/nature/3/" alt=""
                                                    class="timeline-img pull-left"/>Parsley amaranth tigernut silver
                                                beet maize fennel spinach ricebean black-eyed. Tolerably earnestly
                                                middleton extremely distrusts she boy now not. Add and offered prepare
                                                how cordial.</p></div>
                                    </div>
                                    <div class="timeline-entry-inner">
            ...
            <div id="footer">
                <div class="copyright">
                    <a href="#">2014 © KAdmin Responsive Multi-Purpose Template</a> More Templates <a
